...
export function LoginPage() {
  const [activeTab, setActiveTab] = useState<'login' | 'oneid'>('login')
      ...
      <div className={styles.leftPanel}>
        <div className={styles.formContainer}>
          ...
          <div className={styles.tabs}>
            ...
            <button
              type="button"
              className={`${styles.tabButton} ${activeTab === 'oneid' ? styles.activeTab : ''}`}
              onClick={() => setActiveTab('oneid')}
            >
              OneID
            </button>
            <div
          ...
          {activeTab === 'login' ? (
            ...
            <div className={styles.oneidWrapper}>
              <p className={styles.oneidText}>
      ...
      <div className={styles.rightPanel}>
        <div className={styles.mockupContainer}>
          <img
            ...
            alt="Elektron hokimiyat axborot tizimi"
